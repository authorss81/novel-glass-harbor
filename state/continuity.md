...
1. Volume 1: a small contaminated shard is recovered, a weathered transparent hull plate is lifted beside it, and both leave the yard in one witnessed surrender to a Registry seizure; a public provenance duplicate and the crew's measurements, repair-seam records, and scaled drawing survive. Both glass objects are entered in the Morrow circuit custody room. The freed storm anchor is ordinary iron and stays with the crew, so the batch loss is glass, not livelihood.
...
- The physical shard **and the weathered hull plate** leave the deck under the same seizure order and go to the Morrow circuit custody room as two separately entered items. The crew keeps the freed anchor, measurements, repair-seam records, a scaled drawing, names, and a public provenance duplicate, which is a record of the objects and not a copy of their memory. No glass survives in Calder's hands past Chapter 8.
